...
![image-20210624072918932](image-20210624072918932-1624592178263.png)
...
![image-20210624081608525](image-20210624081608525-1624592196369.png)
...
![image-20210624093357280](image-20210624093357280-1624592246001.png)

**板块**

可以在不同主题直接切换:

![image-20210624093556288](image-20210624093556288-1624592260027.png)
...
![image-20210624100536965](image-20210624100536965-1624592277122.png)

**管理**

管理端需登录后才能访问，否则出现：

![image-20210624091046297](image-20210624091046297-1624592285460.png)
...
![image-20210624095005326](image-20210624095005326-1624592292115.png)

**用户管理**

可以对用户进行删除，删除用户后，该用户的所有文章都将会被删除！

![image-20210624095310352](image-20210624095310352-1624592298801.png)

**普通管理员**

无用户管理功能

![image-20210624095410711](image-20210624095410711-1624592305518.png)

**板块管理**

拥有板块添加、板块修改、板块删除功能

![image-20210624095653971](image-20210624095653971-1624592313897.png)

![image-20210624095718096](image-20210624095718096-1624592319672.png)

**内容管理**

拥有内容添加、内容修改、内容删除功能

![image-20210624095840242](image-20210624095840242-1624592327370.png)

![image-20210624095908240](image-20210624095908240-1624592333554.png)

**用户退出与返回博客**

右上角实现这两个功能

![image-20210624100052761](image-20210624100052761-1624592340607.png)

退出后：

![image-20210624100110701](image-20210624100110701-1624592346362.png)